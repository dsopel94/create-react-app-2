!(function(e) {
  ...
  }), (t.p = '/create-react-app-2/build/'), t((t.s = 314));
})([
  function(e, t, n) {
    'use strict';
    ...
    function c(e) {
      return function(t) {
        d.a
          ...
          .then(function(e) {
            (window.location.href = '/create-react-app-2/build/auth/dashboard'), t({ type: p.b, payload: e.data.courses });
          });
      };
    }
    function l(e, t) {
      return function(n) {
        d.a
          ...
          .then(function(e) {
            console.log(
              e.data.courses
            ), (window.location.href = '/create-react-app-2/build/courses/' + e.data.courses._id);
          });
      };
    }
      ...
      y = function(e, t, n) {
        ...
        return function(r) {
          console.log(
            ...
            .then(function(e) {
              window.location.href = '/create-react-app-2/build/login';
            });
        };
      },
          ...
          d.a
            ...
            .then(function(s) {
              a({
                ...
                streetAddress: r,
                miscAddress: o,
              }), (window.location.href = '/create-react-app-2/build/courses/' + i), console.log(window.location.href), console.log(s.data.students, 'Student response');
            });
        };
      },
          ...
          d.a
            ...
            .then(function(e) {
              console.log(
                e.data.students,
                'Checking after put'
              ), (window.location.href = '/create-react-app-2/build/courses/' + e.data.students.courses);
            });
        };
      },
      w = function(e, t) {
        ...
        return function(n) {
          d.a
            ...
            .then(function(t) {
              v.get(
                'instructor'
              ), n({ type: p.f, coursename: e, _creator: v.get('instructor')._id, periods: [] }), (window.location.href = '/create-react-app-2/build/auth/dashboard');
            });
        };
      };
  },
        ...
        return a(t, e), p(t, [
          {
            ...
            value: function(e) {
              ...
              }), (window.location.href = '/create-react-app-2/build/editStudent/' +
                this.props.id);
            },
          },
          {
            ...
            value: function(e) {
              e.preventDefault(), this.setState({
                ...
                e.target.id,
                'Check target id'
              ), (window.location.href = '/create-react-app-2/build/courses/' +
                this.props.courses);
            },
          },
          {
        ...
        return i(t, e), h(t, [
          ...
          },
          {
            ...
            value: function() {
              var e = this;
              this.state.authenticated ||
                (window.location.href = '/create-react-app-2/build/login'), console.log(
                this.state.authenticated,
      ...
      'serviceWorker' in navigator &&
        window.addEventListener('load', function() {
          navigator.serviceWorker
            .register('/create-react-app-2/build/service-worker.js')
            .then(function(e) {
  ...
  function(e, t, n) {
    ...
    (function(t) {
      ...
      'undefined' !== typeof t &&
        n.i({
          NODE_ENV: 'production',
          PUBLIC_URL: '/create-react-app-2/build',
        });
      var u = {
